...
export type DKMonacoEditorProps = {
  style?: CSSProperties;
  className?: string;
...
export const DKMonacoEditorReactComp: React.FC<DKMonacoEditorProps> = (props) => {
    ...
    const startMonaco = async () => {
      if (containerRef.current) {
        try {
          ...
          console.log("wrapper started now onload");
  ...
  }, [onError, onLoad, onTextChanged, wrapperConfig]);
